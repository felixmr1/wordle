// All valid 5-letter words that can be used as guesses
...
// A curated list of common 5-letter words that will be used as solutions
export const SOLUTION_WORDS = [
  "ABOUT", "ABOVE", "ACTOR", "ALERT", "ALIVE", "ALLOW", "ALONE", "APPLE", "BEACH", "BEGIN",
  "BLACK", "BRAIN", "BREAD", "BREAK", "BRING", "BROWN", "BUILD", "CATCH", "CHAIR", "CHILD",
  "CLEAN", "CLEAR", "CLOCK", "CLOSE", "COUNT", "COVER", "DANCE", "DREAM", "DRINK", "DRIVE",
  "EARLY", "EARTH", "EIGHT", "EMPTY", "ENJOY", "ENTER", "EQUAL", "EVERY", "FIGHT", "FIRST",
  "FLOOR", "FOCUS", "FRESH", "FRONT", "FRUIT", "FUNNY", "GHOST", "GLASS", "GRACE", "GRAND",
  "GRASS", "GREAT", "GREEN", "GROUP", "GUARD", "GUESS", "GUEST", "HAPPY", "HEART", "HEAVY",
  "HORSE", "HOUSE", "HUMAN", "LEARN", "LIGHT", "LUCKY", "LUNCH", "MAGIC", "MATCH", "METAL",
  "MONEY", "MONTH", "MOUSE", "MOUTH", "MUSIC", "NIGHT", "NOISE", "OCEAN", "PAINT", "PAPER",
  "PARTY", "PEACE", "PHONE", "PLACE", "PLANT", "POINT", "POWER", "PRICE", "PRIDE", "PRIZE",
  "QUEEN", "QUICK", "QUIET", "RADIO", "READY", "RIGHT", "RIVER", "ROUND", "SCALE", "SHARE",
  "SHARP", "SHEEP", "SHINE", "SHIRT", "SHOOT", "SHORT", "SIGHT", "SLEEP", "SMALL", "SMILE",
  "SMOKE", "SOLID", "SOUND", "SPACE", "SPEAK", "SPEED", "SPEND", "SPORT", "STAGE", "STAND",
  "START", "STATE", "STICK", "STILL", "STONE", "STORE", "STORM", "STORY", "STUDY", "STYLE",
  "SWEET", "TABLE", "TASTE", "TEACH", "THANK", "THEIR", "THERE", "THICK", "THING", "THINK",
  "THREE", "THROW", "TIGER", "TIRED", "TODAY", "TOUCH", "TOWER", "TRACK", "TRAIN", "TREAT",
  "TRUCK", "TRUST", "TRUTH", "UNDER", "VALUE", "VOICE", "WATCH", "WATER", "WHEEL", "WHERE",
  "WHILE", "WHITE", "WHOLE", "WOMAN", "WORLD", "WRITE", "WRONG", "YOUNG", "YOUTH"
];

// Function to get a random solution word
